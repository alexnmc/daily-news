    ...
    return (
            ...
            { props.toggle ?
                ...
                <div className = "navbarWrap" >
                    ...
                    <p className = 'live' onClick = {()=> props.showVideo('https://www.youtube.com/watch?v=p7LX2zNBE6M', 'EURONEWS LIVE')}>Euronews LIVE</p>
                    ...
                    <p className = 'live' onClick = {()=> props.showVideo('https://www.youtube.com/watch?v=0M-pPonAjeM', 'Al Jazeera English LIVE')}>Al Jazeera English LIVE</p>
