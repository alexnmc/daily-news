    ...
    return (
            ...
            { props.toggle ?
                ...
                <div className = "navbarWrap" >
                    ...
                    <p className = 'live' onClick = {()=> props.showVideo('https://www.youtube.com/watch?v=OH7lv06RN3k', 'EURONEWS LIVE')}>Euronews LIVE</p>
                    <p className = 'live' onClick = {()=> props.showVideo('https://www.youtube.com/watch?v=d3_gK9MrXo8', 'France 24 LIVE')}>France 24 LIVE</p>
